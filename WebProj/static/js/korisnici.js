  ...
  <div class="leftcolumn">
    ...
    <div id="prikazKorisnika"  v-if="odabraniKorisnik.korisnickoIme!=undefied" >
						<table>
							...
							<tr><td>Datum rodjenja: {{odabraniKorisnik.datumRodjenja}}</td></tr>
                          	<tr v-if="odabraniKorisnik.uloga=='KUPAC'"><td>Tip kupca: {{odabraniKorisnik.tipKupca.imeTipa}} {{odabraniKorisnik.brojSakupljenihBodova}}</td></tr>
                            <tr v-if="odabraniKorisnik.uloga=='MENADZER'"><td>Restoran: {{odabraniKorisnik.nazivRestorana}}</td></tr>
                          	<tr ><td><button v-on:click="obrisiKorisnika(odabraniKorisnik.korisnickoIme)">Obrisi korisnika</button><br /></td></tr>
		...
		<div class="card">
		  ...
		  <form>
			<table>
			  ...
			  <tr><td><button v-on:click="pretraziKorisnike">Pretrazi</button></td></tr>
			</table>
		</form>
		</div>
	  </div>
