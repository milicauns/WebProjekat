...
(function (global, factory) {
	...
	*/
	...
	}) ? function assign(target, source$$1) { // eslint-disable-line no-unused-vars -- required for `.length`
	...
	function plainProps(object) {
	  ...
	  var isPlain = function isPlain(x) {
	    return isNumeric(x) || isString(x) || isArray$1(x) || isBoolean(x) || isPlainObject(x);
	  };
	...
	function replaceTokens(string, replaces) {
	  ...
	  var regExp = new RegExp(map$2(_context2 = keys$2(replaces)).call(_context2, function (field) {
	    return '(\\{' + field + '\\})';
	  }).join('|'), 'ig');
	...
	function isEqual(value, other) {
	  ...
	  var valueProps = keys$2(value);

	  var otherProps = keys$2(other);
	...
	function isEmpty(value) {
	  return !value || isArrayLike(value) && value.length === 0 || isObjectLike(value) && keys$2(value).length === 0;
	}
	...
	function pick(object, key) {
	  ...
	  if (Array.isArray(key)) {
	    ...
	    keys = concat$2(_context3 = [key]).call(_context3, keys);
	  }
	...
	function range(start, end) {
	  var step,
	      i,
	      _args = arguments;
	  return regenerator.wrap(function range$(_context5) {
	    while (1) {
	...
	function get$1(obj, path, defaultValue) {
	  var travel = function travel(regexp) {
	    ...
	    return reduce$2(_context6 = filter$2(_context7 = String.prototype.split.call(path, regexp)).call(_context7, Boolean)).call(_context6, function (res, key) {
	...
	function arrayLengthValidator(len) {
	  return function (len) {
	    return function (value) {
	      return isArray$1(value) && value.length === len;
	    };
	  };
	}
	...
	function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$1(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$1(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	/**
	...
	function writeGeoJsonFeature(feature) {
	  ...
	  if (Array.isArray(get$1(geoJsonFeature, 'properties.features'))) {
	    var _context;
	...
	function ownKeys$2(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$1(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$2(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$2(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	...
	var isEmpty$1 = function isEmpty$$1(x) {
	  ...
	  return (typeof x === 'string' || Array.isArray(x)) && !x.length || !keys$2(x).length;
	};
	/**
	...
	function extractChildren(slots) {
	  ...
	  return reduce$2(_context = keys$2(slots)).call(_context, function (all, name) {
	...
	function ownKeys$3(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$2(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$3(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$3(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	...
	var arcgisSource = {
	  ...
	  watch: _objectSpread$2(_objectSpread$2(_objectSpread$2({}, makeWatchers(['layers', 'format', 'dpi', 'transparent', 'gdbVersion', 'mapScale', 'rotation', 'historicMoment'], function (prop) {
	    ...
	    extParams: function extParams(value) {
	      if (!this.$source) return;
	      var params = pick(this.$source.getParams() || {}, keys$2(value));
	...
	***************************************************************************** */
	...
	var iterate = function (iterable, unboundFunction, options) {
	  ...
	  var stop = function (condition$$1) {
	    if (iterator) iteratorClose(iterator);
	    return new Result(true, condition$$1);
	  };
	...
	var collectionFrom = function from(source$$1 /* , mapFn, thisArg */) {
	  ...
	  if (mapping) {
	    ...
	    iterate(source$$1, function (nextItem) {
	      array.push(boundFunction(nextItem, n++));
	    });
	  } else {
	    iterate(source$$1, array.push, { that: array });
	  }
	...
	function _isNativeReflectConstruct$1() {
	  ...
	  try {
	    Boolean.prototype.valueOf.call(construct$5(Boolean, [], function () {}));
	    return true;
	  } catch (e) {
	    return false;
	  }
	...
	var rxSubs = {
	  methods: {
	    ...
	    unsubscribe: function unsubscribe(subs) {
	      ...
	      splice$2(_context = this._rxSubs).call(_context, idx, 1);
	    }
	  },
	...
	var IdentityMap = /*#__PURE__*/function () {
	  ...
	  _createClass(IdentityMap, [{
	    ...
	    value: function ids() {
	      ...
	      return keys$2(this._pools[pool]);
	    }
	    /**
	     * @param {string} id
	     * @param {string} pool
	...
	var identMap = {
	  ...
	  methods: {
	    ...
	    unsetInstances: function unsetInstances() {
	      keys$4(this.idents).forEach(this.unsetInstance.bind(this));
	    }
	  }
	};
	...
	function _arrayWithoutHoles(arr) {
	  if (isArray$5(arr)) return _arrayLikeToArray(arr);
	}
	...
	function fromEventPattern(addHandler, removeHandler, resultSelector) {
	    if (resultSelector) {
	        return fromEventPattern(addHandler, removeHandler).pipe(map$4(function (args) { return isArray$2(args) ? resultSelector.apply(void 0, args) : resultSelector(args); }));
	    }
	    return new Observable(function (subscriber) {
	...
	var featuresContainer = {
	  ...
	  computed: {
	    ...
	    featuresViewProj: function featuresViewProj() {
	      ...
	      if (!this.rev) return [];
	      return map$2(_context2 = this.getFeatures()).call(_context2, this.writeFeatureInViewProj.bind(this));
	    },
	    featuresDataProj: function featuresDataProj() {
	      var _context3;

	      if (!this.rev) return [];
	      return map$2(_context3 = this.getFeatures()).call(_context3, this.writeFeatureInDataProj.bind(this));
	    },
	  ...
	  methods: {
	    ...
	    getFeatureById: function getFeatureById(featureId) {
	      ...
	      return find$2(_context4 = this.$featuresCollection.getArray()).call(_context4, function (feature) {
	...
	var cmp = {
	  ...
	  methods: {
	        ...
	        return regenerator.wrap(function _callee$(_context4) {
	          while (1) {
	            switch (_context4.prev = _context4.next) {
	              case 0:
	                _context4.next = 2;
	                return _this.instanceFactoryCall(_this.olObjIdent, _this.createOlObject.bind(_this));

	              case 2:
	                _this._olObject = _context4.sent;
	                _this._olObject[VM_PROP] || (_this._olObject[VM_PROP] = []);

	                if (!includes$4(_context3 = _this._olObject[VM_PROP]).call(_context3, _this)) {
	    ...
	    deinit: function deinit() {
	      ...
	      if (this._olObject) {
	        ...
	        this._olObject[VM_PROP] = filter$2(_context5 = this._olObject[VM_PROP]).call(_context5, function (vm) {
	          return vm !== _this2;
	        });
	  ...
	  beforeDestroy: function beforeDestroy() {
	    ...
	    return _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5() {
	      return regenerator.wrap(function _callee5$(_context9) {
	        while (1) {
	  ...
	  destroyed: function destroyed() {
	    ...
	    return _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6() {
	      return regenerator.wrap(function _callee6$(_context10) {
	        while (1) {
	  ...
	  props: {
	    attributions: {
	      ...
	      validator: function validator(value) {
	        return isString(value) || isArray$1(value) && value.every(isString);
	      }
	    },
	...
	function ownKeys$4(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$3(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$4(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$4(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var imageSource = {
	  mixins: [source$1],
	  props: {
	    crossOrigin: String,
	...
	function ownKeys$5(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$4(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$5(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$5(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var layer = {
	  ...
	  methods: {
	    ...
	    createStyleFunc: function createStyleFunc() {
	      ...
	      return function __styleTargetStyleFunc(feature, resolution) {
	        ...
	        if (styles === null || Array.isArray(styles) && styles.length || styles instanceof style.Style) {
	          return styles;
	...
	*/
	...
	function ownKeys$6(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$5(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$6(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$6(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var tileSource = {
	  ...
	  methods: {
	    ...
	    init: function init() {
	       ...
	       * @protected
	       */
	      this._tileGrid = this.instanceFactoryCall(this.tileGridIdent, this.createTileGrid.bind(this));
	      return source$1.methods.init.call(this);
	    },
	...
	function ownKeys$7(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$6(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$7(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$7(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var vectorSource = {
	...
	function ownKeys$8(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$7(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$8(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$8(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	...
	function ownKeys$9(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$8(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$9(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$9(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	...
	var values_1 = function (it) {
	  var own = it.values;
	  return it === ArrayPrototype$a || (it instanceof Array && own === ArrayPrototype$a.values)
	    // eslint-disable-next-line no-prototype-builtins -- safe
	    || DOMIterables.hasOwnProperty(classof(it)) ? values$5 : own;
	};
	...
	var Builder = /*#__PURE__*/function () {
	  ...
	  _createClass(Builder, [{
	    ...
	    value: function promise() {
	      ...
	      return interval(100).pipe(skipWhile(function () {
	        return !_this.source;
	      }), first(), map$4(this.build.bind(this))).toPromise(promise$5);
	    }
	  }]);
	...
	function ownKeys$a(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$9(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$a(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$a(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var script$4 = {
	...
	function delay(delay, scheduler) {
	    ...
	    return function (source$$1) { return source$$1.lift(new DelayOperator(delayFor, scheduler)); };
	}
	var DelayOperator = /*@__PURE__*/ (function () {
	    ...
	    DelayOperator.prototype.call = function (subscriber, source$$1) {
	        return source$$1.subscribe(new DelaySubscriber(subscriber, this.delay, this.scheduler));
	    };
	...
	var DelaySubscriber = /*@__PURE__*/ (function (_super) {
	    ...
	    DelaySubscriber.dispatch = function (state) {
	        var source$$1 = state.source;
	        var queue = source$$1.queue;
	...
	function ownKeys$b(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$a(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$b(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$b(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	        ...
	        return regenerator.wrap(function _callee$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              ...
	              case 2:
	                source$$1 = _this._source = _context2.sent;
	...
	function subscribeToInteractionChanges() {
	  ...
	  var drawEvents = merge(fromOlEvent(this.$interaction, 'drawstart').pipe(map$4(function (evt) {
	    ...
	    return evt;
	  })), fromOlEvent(this.$interaction, 'drawend').pipe(mergeMap(function (evt) {
	    var obs;

	    if (_this2._source.vm && _this2._source.vm[0]) {
	      obs = fromEventPattern(function (handler) {
	        return _this2._source.vm[0].$on('update:features', handler);
	      }, function (handler) {
	        return _this2._source.vm[0].$off('update:features', handler);
	      });
	    } else {
	      obs = fromOlEvent(_this2._source, 'change').pipe(delay(2 * (1000 / 60)));
	    }

	    return obs.pipe(mapTo(evt), first());
	  })));
	...
	function ownKeys$c(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$b(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$c(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$c(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	/**
	...
	function ownKeys$d(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$c(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$d(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$d(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var script$9 = {
	  name: 'vl-graticule',
	  mixins: [cmp, useMapCmp, projTransforms],
	  props: {
	...
	function ownKeys$e(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$d(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$e(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$e(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var script$b = {
	...
	function ownKeys$f(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$e(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$f(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$f(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var script$c = {
	  name: 'vl-style-icon',
	  mixins: [imageStyle],
	  props: {
	...
	var watch$3 = makeWatchers(keys$2(props$4), function () {
	  return function () {
	    this.scheduleRecreate();
	  };
	});
	...
	function ownKeys$g(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$f(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$g(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$g(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	/**
	...
	var script$h = {
	  ...
	  watch: _objectSpread$f(_objectSpread$f({}, makeWatchers(['keyboardEventTarget', 'loadTilesWhileAnimating', 'loadTilesWhileInteracting', 'moveTolerance', 'pixelRatio', 'renderer', 'maxTilesLoading'], function () {
	    ...
	    defaultControls: function defaultControls(value) {
	      if (value === false) {
	    ...
	    defaultInteractions: function defaultInteractions(value) {
	      if (value === false) {
	      ...
	      this._interactionsCollection.extend(control.defaults(value).getArray());
	    },
	    wrapX: function wrapX(value) {
	...
	function subscribeToEvents$2() {
	  ...
	  hasMap(this);
	  hasView(this); // pointer

	  var pointerEvents = merge(fromOlEvent(this.$map, ['click', 'dblclick', 'singleclick']), fromOlEvent(this.$map, ['pointerdrag', 'pointermove']).pipe(distinctUntilChanged(function (a, b) {
	    return isEqual({
	      t: a.type,
	      c: a.coordinate
	    }, {
	...
	function ownKeys$h(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$g(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$h(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$h(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	/**
	...
	function ownKeys$i(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$h(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$i(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$i(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	/**
	 * @vueProto
	...
	function ownKeys$j(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$i(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$j(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$j(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var script$t = {
	  ...
	  watch: _objectSpread$i({
	    initializedFeature: {
	      ...
	      handler: function handler(features) {
	        ...
	        features.forEach(this.select.bind(this)); // unselect non-matched features

	        difference(this.getFeatures(), features, function (a, b) {
	          return getFeatureId(a) === getFeatureId(b);
	        }).forEach(this.unselect.bind(this));
	      }
	    },
	    featuresDataProj: {
	      deep: true,
	...
	function ownKeys$k(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$j(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$k(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$k(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	/**
	...
	function ownKeys$l(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$k(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$l(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$l(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var script$D = {
	...
	function subscribeToSourceEvents$2() {
	  hasSource(this);
	  this.subscribeTo(fromOlEvent(this.$source, 'tileloadend'), function (evt) {
	    if (!evt.tile) {
	      return;
	    }
	...
	function ownKeys$m(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$l(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$m(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$m(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var script$G = {
	  name: 'vl-source-wms',
	...
	function ownKeys$n(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$m(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$n(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$n(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var script$H = {
	  name: 'vl-source-wmts',
	  mixins: [tileSource],
	  props: {
	...
	function ownKeys$o(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread$n(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$o(Object(source$$1), true).forEach(function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { Object.defineProperties(target, getOwnPropertyDescriptors$2(source$$1)); } else { ownKeys$o(Object(source$$1)).forEach(function (key) { Object.defineProperty(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
